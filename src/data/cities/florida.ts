...
export const floridaCities: CityLocation[] = [
  ...
  },
  {
    ...
    county: "Miami-Dade County",
    climate: "tropical",
    climateDriver: "Aventura sits on a barrier island between Biscayne Bay and the Atlantic Ocean in northern Miami-Dade County, with a fully tropical climate that delivers year-round warmth, high humidity, and no frost. The coastal location and the Intracoastal Waterway create standing-water mosquito breeding habitat and support the year-round termite pressure for which South Florida is nationally recognized.",
    topPests: ["Subterranean Termites", "Drywood Termites", "Mosquitoes", "German Cockroaches", "Ants"],
    pestProfile: [
      { name: "Subterranean Termites", serviceSlug: "termite-treatment", activeSeason: "Year-round, swarms April through June", note: "Formosan subterranean termites are established throughout Aventura and swarm in large numbers from May through June, often visible swarming around the lights of high-rise common areas." },
      { name: "Drywood Termites", serviceSlug: "termite-treatment", activeSeason: "Year-round, peak July through October", note: "Drywood termites infest the wood framing and furniture of Aventura's high-rise condos and townhouses, traveling in infested furniture and wood items brought by new residents." },
      { name: "Mosquitoes", serviceSlug: "mosquito-control", activeSeason: "Year-round, peak June through October", note: "Aventura's Intracoastal Waterway frontage, the urban tree canopy near Founders Park, and the city's many landscaped retention areas sustain mosquito populations throughout the year." },
      { name: "German Cockroaches", serviceSlug: "cockroach-control", activeSeason: "Year-round", note: "The high density of restaurants along Aventura Mall and Biscayne Boulevard creates cockroach pressure that extends into adjacent residential high-rises through shared drainage infrastructure." },
      { name: "Ants", serviceSlug: "ant-control", activeSeason: "Year-round", note: "Ghost ants, white-footed ants, and bigheaded ants are all common in Aventura condos, entering through utility conduits and window seals in buildings where one unit's infestation becomes a floor-wide problem." },
    ],
    localHook: "Two pests define the work here: Formosan subterranean termites and drywood termites, which attack Aventura structures from opposite directions and together make termite management the city's most important ongoing pest investment.",
    ...
    contentTemplate: "C",
    contentSoul: "comparison",
    metaTitle: "Pest Control in Aventura, FL",
    metaDescription: "Aventura FL pest control for Formosan termites, drywood termites, and mosquitoes. Condo and high-rise expertise. Free inspection. Call 1-800-PEST-USA.",
  },
  {
    slug: "dania-beach",
    name: "Dania Beach",
    ...
    county: "Broward County",
    climate: "tropical",
    climateDriver: "Dania Beach is a small coastal city in southern Broward County between Fort Lauderdale and Hollywood, with direct Atlantic beachfront and the Port Everglades shipping channel nearby. The tropical climate, coastal humidity, and the antiques and import trade concentrated here create unique pest entry vectors, particularly for drywood termites and stored-product pests arriving in imported goods.",
    topPests: ["Drywood Termites", "Subterranean Termites", "American Cockroaches", "Mosquitoes", "Ants"],
    pestProfile: [
      { name: "Drywood Termites", serviceSlug: "termite-treatment", activeSeason: "Year-round, swarms July through October", note: "Dania Beach's antiques district and proximity to Port Everglades create unusually high drywood termite introduction risk from infested furniture and imported wood goods arriving in the city." },
      { name: "Subterranean Termites", serviceSlug: "termite-treatment", activeSeason: "Year-round, Formosan swarms May through June", note: "Formosan and native subterranean termites are both present in Dania Beach's older residential neighborhoods and the landscaped areas around the port corridor." },
      { name: "American Cockroaches", serviceSlug: "cockroach-control", activeSeason: "Year-round", note: "American cockroaches exploit Dania Beach's older drainage infrastructure and the high-humidity coastal environment, with populations particularly dense near the marina and older commercial properties." },
      { name: "Mosquitoes", serviceSlug: "mosquito-control", activeSeason: "Year-round, peak June through October", note: "The tidal areas near the Intracoastal Waterway and the standing-water pockets in Dania Beach's older residential areas sustain year-round mosquito populations." },
      { name: "Ants", serviceSlug: "ant-control", activeSeason: "Year-round", note: "White-footed ants are particularly problematic in Dania Beach's older homes, where they exploit wood-to-soil contact points and aging siding to establish extensive interior colonies." },
    ],
    localHook: "Two pests define the work here: drywood termites and American cockroaches, which both use Dania Beach's antiques trade and aging infrastructure as pathways into homes that newer, more isolated cities rarely face.",
    ...
    sections: [
      {
        heading: "Compare the seasons: drywood termites vs. American cockroaches",
      ...
      {
        heading: "The contrast that matters: antique-filled homes vs. newer builds",
        body: "Dania Beach properties with antique furniture, imported wood pieces, or architectural salvage face a categorically higher drywood termite risk than homes furnished exclusively with new goods. Every piece of antique wood is a potential drywood colony introduction, and the city's antiques district concentration means this risk is higher here than almost anywhere else in Broward County. Newer construction homes in Dania Beach are more vulnerable to subterranean termites from soil contact and to cockroaches from aging infrastructure, but less susceptible to drywood introduction through commerce. Your home's furnishing history shapes your termite risk profile.",
      },
    ],
    prevention: [
      "Inspect all antique wood furniture for drywood termite frass, pellets, and exit holes before bringing it into the home.",
      "Request a full WDO inspection before purchasing any property in the antiques district or older residential blocks.",
      "Seal floor drains and inspect P-traps monthly to block American cockroach entry from the drainage system.",
      "Clear standing water from yard depressions and ornamental containers every 72 hours during mosquito season.",
      "Apply a perimeter treatment to the foundation and landscaping annually, targeting both subterranean termite entry and ant foraging trails.",
    ],
    costNote: "Dania Beach homeowners typically invest in both a subterranean termite bait station agreement and periodic drywood termite spot treatments, with cockroach management handled as part of a quarterly perimeter plan.",
    faqs: [
      { question: "How do I know if antique furniture I bought in Dania Beach has drywood termites?", answer: "Look for frass, which are tiny pellets with six distinct ridges that accumulate in small piles below the wood. Also check for small round exit holes, about the size of a pencil tip, on wood surfaces. Active infestations produce fresh frass continuously. If you buy furniture in Dania Beach's antiques district, inspect it before bringing it inside and consider having it heat-treated or fumigated before introduction. One piece of infested wood can establish a colony in your home's framing within a year." },
      { question: "Why are American cockroaches so common near the Port Everglades area of Dania Beach?", answer: "Port Everglades is one of the busiest container ports in the US, and the shipping and warehouse infrastructure around the port creates large outdoor cockroach populations in drainage, stormwater, and utility infrastructure. American cockroaches do not reproduce rapidly indoors, but the outdoor population reservoir near the port is large enough to continuously pressure nearby residential properties. Gaps in foundations, drain covers, and door sweeps are the primary entry points." },
      { question: "Do tidal areas near Dania Beach increase mosquito-borne disease risk?", answer: "Tidal zones support salt marsh mosquitoes in addition to the standing-water Culex species that carry West Nile virus. Salt marsh mosquitoes are aggressive biters but are less associated with disease transmission. Culex quinquefasciatus, the southern house mosquito, is the primary West Nile vector in Broward County and breeds in the stagnant standing water of urban areas. Mosquito-borne disease risk in Dania Beach is moderate to high during summer, and Broward County Mosquito Control conducts regular surveillance and aerial treatment." },
      { question: "Are Formosan termites active in the older parts of Dania Beach?", answer: "Yes. Formosan subterranean termites are established throughout Broward County, and Dania Beach's older residential neighborhoods and landscaped areas have been exposed for decades. Formosan swarms occur from May through June, typically after warm rains at dusk. Seeing swarmers around streetlights or building lights during this window is a reliable indicator of local colony activity. The species is significantly more destructive than native subterranean termites and warrants immediate professional inspection." },
    ],
    author: "Dr. Lena Ortiz, Board-Certified Entomologist, PestRemovalUSA",
    nearbyCities: [
      { name: "Hollywood", slug: "hollywood" },
    ...
    contentTemplate: "C",
    contentSoul: "comparison",
    metaTitle: "Pest Control in Dania Beach, FL",
    metaDescription: "Dania Beach FL pest control for drywood termites, cockroaches, and mosquitoes. Antiques district expertise. Free inspection. Call 1-800-PEST-USA.",
  },
  {
    slug: "cooper-city",
    name: "Cooper City",
    ...
    county: "Broward County",
    climate: "tropical",
    climateDriver: "Cooper City is a planned residential community in central Broward County, surrounded by the Everglades conservation buffer to the west and dense suburban development to the east. The proximity to Everglades wetlands creates a constant mosquito pressure gradient, while the tropical climate sustains year-round termite activity and the ant species that dominate South Florida's residential pest landscape.",
    topPests: ["Subterranean Termites", "Mosquitoes", "Ants", "German Cockroaches", "Rats"],
    pestProfile: [
      { name: "Subterranean Termites", serviceSlug: "termite-treatment", activeSeason: "Year-round, Formosan swarms May through June", note: "Cooper City's western edge backs against Everglades Conservation Area buffer lands where high moisture and organic soil sustain large Formosan subterranean termite colonies that pressure adjacent residential properties." },
      { name: "Mosquitoes", serviceSlug: "mosquito-control", activeSeason: "Year-round, peak June through October", note: "The Everglades wetland edge west of Cooper City is one of the most productive mosquito breeding zones in Broward County, and evening winds carry mosquitoes from conservation areas into residential yards." },
      { name: "Ants", serviceSlug: "ant-control", activeSeason: "Year-round", note: "White-footed ants, ghost ants, and bigheaded ants all infest Cooper City homes, with bigheaded ants being a significant concern in the western neighborhoods due to their origin in disturbed Everglades-adjacent soils." },
      { name: "German Cockroaches", serviceSlug: "cockroach-control", activeSeason: "Year-round", note: "Cooper City's restaurant strip along Griffin Road sustains German cockroach populations that pressure adjacent residential areas through shared infrastructure." },
      { name: "Rats", serviceSlug: "rat-control", activeSeason: "October through April", note: "Roof rats use the Everglades conservation buffer tree canopy as a corridor into Cooper City's residential neighborhoods, moving into homes as cool-season nights fall." },
    ],
    localHook: "Two pests define the work here: Formosan subterranean termites and mosquitoes, which both originate in the same Everglades wetland edge that defines Cooper City's western boundary.",
