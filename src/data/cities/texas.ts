...
export const texasCities: CityLocation[] = [
...

  {
    ...
    contentTemplate: "A",
    contentSoul: "operator",
    metaTitle: "Pest Control in North Richland Hills, TX | Fire Ants & Termites",
    metaDescription: "Fire ants, termites, and cockroaches are year-round problems in North Richland Hills, TX. Licensed local techs cover Tarrant County. Free inspection. Call 1-800-PEST-USA.",
  },

  {
    ...
    costNote: "Pest control pricing in Hurst is in line with the broader Tarrant County Mid-Cities market. Quarterly pest control contracts covering cockroaches, mice, and spiders typically run $120 to $180 per quarter for a standard suburban home. A one-time fire ant broadcast treatment costs approximately $80 to $150 depending on lot size. Termite inspections are commonly offered free of charge, with treatment costs for a slab-foundation home in the 1,500 to 2,500 square foot range generally running $800 to $1,400 for a liquid barrier application.",
    faqs: [
      {
        question: "Why does my Hurst apartment building keep getting cockroaches even after treatment?",
    ...
    contentTemplate: "B",
    contentSoul: "neighbor",
    metaTitle: "Pest Control in Hurst, TX | Cockroaches, Mice & Fire Ants",
    metaDescription: "German cockroaches, house mice, and fire ants are persistent in Hurst, TX. Serving the HEB Mid-Cities area in Tarrant County. Free inspection. Call 1-800-PEST-USA.",
  },

  {
    ...
    contentTemplate: "C",
    contentSoul: "comparison",
    metaTitle: "Pest Control in Keller, TX | Scorpions, Fire Ants & Termites",
    metaDescription: "Scorpions, termites, and fire ants are active in Keller, TX. Limestone terrain raises scorpion risk in north Tarrant County. Free inspection. Call 1-800-PEST-USA.",
  },

  {
    ...
    contentTemplate: "D",
    contentSoul: "qa",
    metaTitle: "Pest Control in Southlake, TX | Scorpions, Termites & Mosquitoes",
    metaDescription: "Scorpions, termites, and mosquitoes are active near Lake Grapevine in Southlake, TX. Serving northeast Tarrant County. Free inspection. Call 1-800-PEST-USA.",
  },

  {
    ...
    contentTemplate: "E",
    contentSoul: "brief",
    metaTitle: "Pest Control in Watauga, TX | Fire Ants, Mice & Cockroaches",
    metaDescription: "Fire ants, house mice, and cockroaches are year-round problems in Watauga, TX. Serving northeast Tarrant County. Free inspection. Call 1-800-PEST-USA.",
  },
  {
    slug: "duncanville",
    name: "Duncanville",
    ...
    contentTemplate: "E",
    contentSoul: "brief",
    metaTitle: "Pest Control in Duncanville, TX | Termites, Cockroaches & Fire Ants",
    metaDescription: "Duncanville TX pest control for subterranean termites, cockroaches, fire ants and mosquitoes. Dallas County Blackland Prairie clay soil specialists. Free inspection. Call 1-800-PEST-USA.",
  },
  {
    slug: "greenville-tx",
    name: "Greenville",
    ...
    costNote: "Termite treatment in Greenville and Hunt County runs $800 to $2,200 for a standard slab home. General pest control programs average $45 to $75 per month. Mosquito yard treatments near the South Sulphur River corridor average $65 to $100 per visit during the warm season.",
    faqs: [
      {
        question: "How does Hunt County's Blackland Prairie soil affect termite risk in Greenville?",
