...
},
{
  ...
  // Chunk 86 additions
  {
    ...
    contentTemplate: "D",
    contentSoul: "qa",
    metaTitle: "Pest Control in Harrisburg, NC | Cabarrus County",
    metaDescription: "Harrisburg, NC pest control for termites, mice, mosquitoes, and stink bugs. Licensed Cabarrus County service northeast of Charlotte.",
  },
  {
    slug: "weddington-nc",
    name: "Weddington",
    ...
    costNote: "Weddington pest control pricing reflects the Union County market for larger wooded properties. Tick and yellow jacket treatments are often additional services beyond a standard perimeter plan. Termite inspections are typically offered at no cost. Contact a licensed North Carolina technician for a large-lot-specific estimate.",
    faqs: [
      {
        question: "Are yellow jackets in Weddington's wooded lots dangerous?",
        answer: "Yes. Yellow jackets become significantly aggressive when their nest is disturbed, and a single nest can contain thousands of workers by late summer. Unlike bees, yellow jackets can sting multiple times. Ground nests are particularly hazardous because they are not always visible until you step near them. If you find a nest, do not attempt to remove it yourself. A licensed technician treats the nest opening with appropriate product at dusk when workers are inside.",
      },
      {
        question: "Can I get Lyme disease from ticks in Weddington, NC?",
        answer: "Blacklegged ticks (deer ticks) capable of transmitting Lyme disease are present in Union County, and Lyme disease cases have been reported in North Carolina. The risk from any single tick bite is low but not zero. The tick must typically be attached for 36 to 48 hours to transmit the bacterium. Check for ticks promptly after outdoor time in wooded areas and remove attached ticks with fine-tipped tweezers, pulling straight out without twisting. Consult a physician if you develop a rash or flu-like symptoms in the weeks after a tick bite.",
      },
      {
        question: "Why does my Weddington home get so many stink bugs in fall?",
        answer: "Weddington's tree canopy concentrates stink bugs in the fall. They aggregate on the warm south and west-facing sides of buildings and on tree trunks before moving into wall voids through gaps at eaves, windows, and utility penetrations. The larger the tree canopy around the home, the more stink bugs are in the local population using those trees as a staging area. A late August perimeter treatment and thorough gap sealing before September meaningfully reduces how many make it inside.",
      },
    ],
    ...
    contentTemplate: "D",
    contentSoul: "qa",
    metaTitle: "Pest Control in Weddington, NC | Union County",
    metaDescription: "Weddington, NC pest control for carpenter ants, deer ticks, yellow jackets, and termites on large wooded lots. Licensed Union County service.",
  },
  {
    slug: "wendell-nc",
    name: "Wendell",
    ...
    costNote: "Wendell pest control pricing reflects the Wake County market. Older homes may need additional inspection time for crawl spaces. Termite inspections are typically offered at no cost by licensed companies. Contact a licensed North Carolina technician for a site-specific estimate.",
    faqs: [
      {
        question: "How do I get rid of fire ants in my Wendell yard for good?",
        answer: "Fire ants cannot be permanently eliminated from an area because new queens and colonies move in from adjacent properties. The practical goal is keeping the population on your property low enough that it is not a hazard. A broadcast bait application to the whole yard twice per year, in spring and fall, reduces the overall population. Treating visible mounds directly handles immediate hazards. Combining broadcast and mound treatment is more effective than either alone.",
      },
      {
        question: "Are mosquitoes bad in Wendell compared to closer-in Raleigh suburbs?",
        answer: "Eastern Wake County communities like Wendell can see higher mosquito pressure than more urbanized Raleigh suburbs because of the surrounding agricultural land, its drainage patterns, and flat terrain that holds water. The proximity to open fields and tree lines also provides more resting habitat for adult mosquitoes. A barrier spray program from April through October and eliminating standing water on the property are the baseline controls.",
      },
      {
        question: "What is the quickest way to tell if I have mice in my Wendell home?",
        answer: "The clearest signs are dark brown droppings the size of a grain of rice along wall edges and in cabinet corners, gnaw marks on food packaging or wood, and nesting material such as shredded paper or insulation in secluded areas. You may also hear scratching in wall voids or ceiling spaces at night. Mice are nocturnal, so most activity happens after dark. If you find droppings in the kitchen or pantry, the infestation is likely more advanced than a single mouse.",
      },
    ],
