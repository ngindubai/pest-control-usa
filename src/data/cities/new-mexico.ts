...
export const newMexicoCities: CityLocation[] = [
  ...
  },
  {
    ...
    county: "Sandoval County",
    climate: "semi-arid",
    climateDriver: "Corrales sits in the Rio Grande valley at about 5,036 feet, wedged between Rio Rancho and Albuquerque's North Valley but separated from both by a deliberate choice to stay rural. The village runs along a stretch of Rio Grande bosque, the cottonwood forest that follows the river, and a network of Spanish colonial era acequias still irrigates its orchards, vineyards and horse pastures. That combination of ditch water and river-bottom moisture gives Corrales a wetter, greener pest profile than most of New Mexico's high desert towns, even though the surrounding uplands stay dry.",
    topPests: ["Mosquitoes", "Subterranean Termites", "Black Widow Spiders", "Deer Mice", "Stable Flies"],
    pestProfile: [
      {
        name: "Mosquitoes",
        serviceSlug: "mosquito-control",
        activeSeason: "Spring through fall, heaviest after monsoon rain and irrigation",
        note: "Sandoval County's mosquito vector control program specifically targets the Rio Grande and bosque corridor that runs through Corrales, sending misting trucks to reach the standing water in the cottonwood bosque and irrigation ditches, a level of mosquito pressure most New Mexico high desert towns do not have.",
      },
      {
        name: "Subterranean Termites",
        serviceSlug: "termite-treatment",
        activeSeason: "Year-round below ground, swarms in spring",
        note: "The acequia system that keeps Corrales' orchards and horse pastures green all summer also keeps soil moisture higher than a typical Rio Grande valley lot, and that moisture is exactly what subterranean termites need to move from the soil into a home's wood framing.",
      },
      {
        name: "Black Widow Spiders",
        serviceSlug: "spider-control",
        activeSeason: "Year-round, most active in warmer months",
        note: "Corrales' horse barns, tack rooms and hay storage sheds, more common here than almost anywhere else in the Albuquerque metro area, give black widow spiders the dark, undisturbed cover they favor.",
      },
      {
        name: "Deer Mice",
        serviceSlug: "mice-control",
        activeSeason: "Year-round, surge into structures and barns in fall",
        note: "New Mexico has documented hantavirus cases carried by deer mice, and Corrales' horse properties and outbuildings, many left open to the fields for animal access, give mice more ways into a barn or shed than a closed suburban garage would.",
      },
      {
        name: "Stable Flies",
        serviceSlug: "fly-control",
        activeSeason: "Spring through fall, worst around manure and hay",
        note: "Corrales' horse-property culture means manure management and hay storage are part of daily life on many lots, and stable flies breed in exactly that kind of organic material, biting animals and people alike near barns and corrals.",
      },
    ],
    localHook: "Corrales has intentionally protected its rural identity since incorporating as a village in 1971, keeping the irrigation ditches, horse pastures and cottonwood bosque that define the Rio Grande valley's older agricultural character even as Rio Rancho and Albuquerque grew up around it on both sides. Sandoval County's mosquito vector control program now runs mist trucks along the Rio Grande and bosque corridor that borders the village, a direct response to the standing water that same river-bottom setting creates.",
    intro: "Pest control in Corrales has to account for a Rio Grande valley village that chose to stay agricultural on purpose. At about 5,036 feet between Rio Rancho and Albuquerque's North Valley, Corrales keeps its orchards, vineyards and horse pastures watered through a Spanish colonial era acequia system, and that irrigation, plus the cottonwood bosque along the river, gives the village more standing moisture than most New Mexico high desert towns ever see. Sandoval County now runs a mosquito vector control program specifically along the Rio Grande and bosque corridor bordering Corrales, using misting trucks to reach the breeding water in the ditches and river bottom. Subterranean termites move more easily from moist soil into wood framing here than in a drier upland lot, black widow spiders settle into the barns and tack rooms that come with the village's horse-property culture, and stable flies breed in the manure and hay storage that same culture requires. Deer mice round out the picture, with New Mexico's documented hantavirus history making barn and outbuilding activity worth taking seriously rather than ignoring.",
    sections: [
      {
        heading: "Why Corrales' Acequias Change the Pest Picture",
        body: "Corrales' irrigation ditches, some tracing routes laid out by Spanish colonial settlers, still water the orchards, vineyards and pastures that give the village its rural character, and that water does more than grow crops. It raises soil moisture across properties that would otherwise sit in the same dry Rio Grande valley as Rio Rancho or Albuquerque, and higher soil moisture is exactly the condition subterranean termites need to travel from the ground into a home's wood framing. A termite inspection in Corrales has to account for ditch-adjacent moisture in a way a drier upland New Mexico lot does not.",
      },
      {
        heading: "Sandoval County's Mosquito Program and the Bosque Corridor",
        body: "The Rio Grande bosque that runs along Corrales' western edge holds standing water after irrigation and rain longer than the dry arroyos found across most of New Mexico, and Sandoval County has responded with a dedicated vector control program that sends misting trucks along the river and bosque corridor to target mosquito breeding sites. That county-level response is itself a sign of how different Corrales' mosquito pressure is from a typical high desert New Mexico town, where standing water simply is not present in the same volume.",
      },
      {
        heading: "Horse Properties, Barns and the Pests That Come With Them",
        body: "Corrales has one of the highest concentrations of horse properties in the Albuquerque metro area, and barns, tack rooms and hay storage sheds bring their own pest pressure. Black widow spiders favor the dark, undisturbed corners those structures provide, and stable flies breed directly in manure and old hay, biting animals and the people who care for them. Deer mice move into barns and outbuildings that stay open to the fields for animal access, and New Mexico's documented hantavirus history means any enclosed space with rodent droppings deserves a careful, disinfectant-first cleanup rather than dry sweeping.",
      },
    ],
    prevention: [
      "Keep irrigation ditches and standing water on the property clear of debris so mosquitoes have fewer places to breed between Sandoval County's vector control passes.",
      "Have a termite inspection done on any home near an acequia or irrigated pasture, since ditch water raises soil moisture well above a typical Rio Grande valley lot.",
      "Clear cobwebs and clutter from barns, tack rooms and hay sheds periodically to keep black widow spider populations from building up.",
      "Manage manure and old hay promptly around horse properties, since both are prime stable fly breeding material.",
    ],
    costNote: "A general mosquito, termite inspection, spider and rodent treatment plan in Corrales typically runs $150 to $350 depending on property size, with barn and outbuilding service often quoted separately for horse properties. Free inspection and written estimate included before any work begins.",
    faqs: [
      {
        question: "Does Corrales really have more mosquitoes than other New Mexico towns?",
        answer: "Yes. Sandoval County runs a dedicated mosquito vector control program with misting trucks specifically along the Rio Grande and bosque corridor that borders Corrales, targeting standing water in the river bottom and irrigation ditches that most high desert New Mexico towns simply do not have.",
      },
      {
        question: "Why would a home in Corrales need a termite inspection more than one in Rio Rancho?",
        answer: "Corrales' acequia irrigation system keeps soil moisture higher across many properties than a typical Rio Rancho or Albuquerque lot, and that moisture is what allows subterranean termites to move from the soil into wood framing. A home near a ditch or irrigated pasture is a reasonable candidate for a termite inspection even without visible damage.",
      },
      {
        question: "Are black widow spiders a real concern on Corrales horse properties?",
        answer: "Yes. Corrales has one of the highest concentrations of horse properties in the Albuquerque metro area, and barns, tack rooms and hay sheds give black widows exactly the dark, undisturbed cover they prefer. Clearing cobwebs and clutter periodically and wearing gloves before reaching into storage areas reduces the risk of a bite.",
      },
      {
        question: "Is hantavirus a concern for Corrales barns and outbuildings?",
        answer: "New Mexico has documented hantavirus cases carried by deer mice, and Corrales' many open barns and outbuildings give mice more access than a closed suburban garage would. If droppings or nesting material turn up, wetting the area with disinfectant before cleaning, rather than dry sweeping, is the safe approach.",
      },
    ],
    author: "Dr. Lena Ortiz, Board-Certified Entomologist (BCE), PestRemovalUSA",
    nearbyCities: [
      { name: "Raton", slug: "raton-nm", stateSlug: "new-mexico" },
      { name: "Anthony", slug: "anthony-nm", stateSlug: "new-mexico" },
    ],
    contentTemplate: "C",
    contentSoul: "comparison",
    metaTitle: "Pest Control in Corrales, NM | Mosquitoes, Termites & Horse Property Pests",
    metaDescription: "Corrales, NM pest control for mosquitoes, subterranean termites, black widow spiders and horse-property pests along the Rio Grande bosque. Free inspection. Call 1-800-PEST-USA.",
  },
  {
    slug: "raton-nm",
    name: "Raton",
    ...
    climate: "cold",
    climateDriver: "Raton sits at roughly 6,600 feet at the base of Raton Pass in the Sangre de Cristo foothills, right where northeastern New Mexico meets southern Colorado. Winters here are genuinely cold, with an average of 46 inches of snow a year, well above the national average, and that colder, higher elevation climate holds back the scorpion and heat-driven pest pressure that defines most of the rest of New Mexico. What it does not hold back is rodent activity, since Raton's older brick downtown and surrounding ranch and cabin properties give mice a warm place to go once the snow starts.",
    topPests: ["Deer Mice", "Boxelder Bugs", "Ticks", "Wasps and Yellow Jackets"],
    pestProfile: [
      {
        name: "Deer Mice",
        serviceSlug: "mice-control",
        activeSeason: "Year-round, surge indoors as cold weather sets in",
        note: "New Mexico has documented hantavirus cases carried by deer mice, and Raton's cold winters push mice toward any warm building, cabin, or outbuilding earlier in the season than a lower desert New Mexico town would see.",
      },
      {
        name: "Boxelder Bugs",
        serviceSlug: "boxelder-bug-control",
        activeSeason: "Congregate on sun-warmed walls each fall",
        note: "Boxelder bugs are common across New Mexico's cooler, higher-elevation towns, and Raton's sunny south and west-facing walls, warmed even on a cold day, draw large gatherings of them looking for a way inside before winter.",
      },
      {
        name: "Ticks",
        serviceSlug: "flea-tick-treatment",
        activeSeason: "Spring through summer, in grassy foothill areas",
        note: "The grassland and pine foothills around Raton Pass and the Sangre de Cristo range give ticks more habitat through the warmer months than the low desert towns farther south in the state, a real difference for pets and hikers using the area's trails.",
      },
      {
        name: "Wasps and Yellow Jackets",
        serviceSlug: "wasp-bee-removal",
        activeSeason: "Spring through fall, nest in eaves of older buildings",
        note: "Raton's Downtown Historic District has close to a hundred buildings dating to the coal mining era, and the eaves, cornices and gaps in that older brick construction give wasps and yellow jackets plenty of places to build a nest undisturbed.",
      },
    ],
    localHook: "Raton grew up at Willow Springs, a Santa Fe Trail stop at the base of Raton Pass, the highest point on that historic wagon route and now a National Historic Landmark. The Atchison, Topeka and Santa Fe Railway arrived in 1879 and turned Raton into a coal mining boomtown, and the roughly 200 acre Raton Downtown Historic District, with close to a hundred surviving buildings including the 1915 Shuler Theater, is a direct legacy of that era.",
    intro: "Pest control in Raton starts with elevation. At around 6,600 feet at the base of Raton Pass, in the Sangre de Cristo foothills near the Colorado border, Raton runs colder than almost anywhere else in New Mexico, averaging 46 inches of snow a year against a national average of 28. That cold holds back the scorpion and heat pest pressure found across most of the state, but it does not reduce rodent activity. New Mexico's documented hantavirus history with deer mice matters here because cold weather pushes mice toward any warm shelter earlier in the season, whether that is a home, a cabin, or an outbuilding. Boxelder bugs gather by the hundreds on sun-warmed walls each fall looking for a way in before winter sets in fully. Ticks stay active through spring and summer in the grassland and pine foothills around Raton Pass, and wasps and yellow jackets nest readily in the eaves of the roughly one hundred surviving buildings in Raton's coal-era downtown historic district.",
    sections: [
      {
        heading: "How Raton's Elevation Reshapes New Mexico's Usual Pest Calendar",
        body: "Most New Mexico pest guidance assumes desert heat: scorpions, cockroaches, and pests that need long warm nights to stay active. Raton, at roughly 6,600 feet with winters that bring an average of 46 inches of snow, simply does not have that heat, so those desert-driven pests are far less of a factor here than in Albuquerque or Las Cruces. What Raton has instead is a genuinely cold mountain climate that pushes rodents toward shelter earlier and harder every fall, since a deer mouse or house mouse facing a Colfax County winter has much stronger incentive to find a warm building than one in a mild desert town.",
      },
      {
        heading: "Deer Mice, Hantavirus and Raton's Ranch and Cabin Properties",
        body: "New Mexico has documented hantavirus pulmonary syndrome cases tied to deer mice, and that risk applies across the state regardless of elevation. Raton's surrounding ranch land and mountain cabin properties, many closed up for stretches during the coldest months, give deer mice quiet, undisturbed spaces to nest. Airing out a closed cabin or outbuilding before walking in, rather than entering directly, and wetting any droppings or nesting material with disinfectant before cleaning rather than dry sweeping, are the safe first steps recommended statewide.",
      },
      {
        heading: "Boxelder Bugs and Wasps in Raton's Historic Downtown",
        body: "Raton's Downtown Historic District, close to 200 acres with nearly a hundred surviving buildings from the coal mining era, including the 1915 Shuler Theater, gives boxelder bugs and wasps plenty of older brick and cornice work to exploit. Boxelder bugs gather on sun-facing walls by the hundreds each fall, drawn to the warmth before winter, and gaps in aging masonry or trim give them easy entry. Wasps and yellow jackets build nests in eaves and overhangs on the same older buildings, and a nest tucked into a cornice or roofline on a downtown storefront is often not noticed until it is already established.",
      },
    ],
    prevention: [
      "Air out cabins, sheds and outbuildings that have been closed up through the coldest months before walking in, rather than entering directly, given New Mexico's documented hantavirus history.",
      "Seal gaps around foundations, doors and windows before fall, since Raton's cold winters push rodents toward any available entry point earlier than in a milder New Mexico town.",
      "Expect boxelder bugs to gather on sun-warmed exterior walls each fall and caulk cracks and gaps where they cluster to reduce how many get inside.",
      "Have eaves, cornices and rooflines on older buildings checked each spring for new wasp or yellow jacket nests before they grow through the summer.",
    ],
    costNote: "A general rodent exclusion, boxelder bug and wasp treatment plan in Raton typically runs $150 to $300, with hantavirus-safe cleanup in enclosed cabins or outbuildings sometimes quoted separately. Free inspection included with most service plans.",
    faqs: [
      {
        question: "Does Raton's cold climate mean fewer pest problems than lower New Mexico towns?",
        answer: "It means a different pest problem, not fewer. Raton's elevation and cold winters, with an average of 46 inches of snow a year, hold back scorpions and other heat-driven pests found across most of New Mexico, but they push rodents toward warm shelter earlier and harder each fall, which is the bigger concern for a Raton property.",
      },
      {
        question: "Is hantavirus a real risk in Raton?",
        answer: "New Mexico has documented hantavirus pulmonary syndrome cases carried by deer mice statewide, and Raton's surrounding ranch and cabin properties, often closed up through the coldest months, give mice quiet places to nest. Airing out a closed building before entering and wetting any droppings with disinfectant before cleaning are the recommended precautions.",
      },
      {
        question: "Why does Raton get so many boxelder bugs in the fall?",
        answer: "Boxelder bugs are common across New Mexico's cooler, higher-elevation towns, and Raton's sun-facing walls draw them by the hundreds looking for warmth before winter. They gather on the outside of buildings first, then work through any gap or crack to get inside, which is why caulking exterior cracks each fall helps.",
      },
      {
        question: "Why do wasps keep nesting in downtown Raton's older buildings?",
        answer: "Raton's Downtown Historic District has close to a hundred surviving buildings from the coal mining era, and the eaves, cornices and gaps in that older construction give wasps and yellow jackets undisturbed places to build a nest. A spring inspection of eaves and rooflines catches a new nest before it grows through the summer months.",
      },
    ],
    author: "Marcus Reed, Lead Pest Control Technician, State-Licensed Applicator",
    nearbyCities: [
      { name: "Corrales", slug: "corrales-nm", stateSlug: "new-mexico" },
      { name: "Anthony", slug: "anthony-nm", stateSlug: "new-mexico" },
    ],
    contentTemplate: "C",
    contentSoul: "comparison",
    metaTitle: "Pest Control in Raton, NM | Deer Mice, Boxelder Bugs & Wasps",
    metaDescription: "Raton, NM pest control for deer mice, boxelder bugs, ticks and wasps in the Sangre de Cristo foothills near Raton Pass. Free inspection. Call 1-800-PEST-USA.",
  },
  {
    slug: "anthony-nm",
    name: "Anthony",
    ...
    county: "Dona Ana County",
    climate: "desert",
    climateDriver: "Anthony sits at about 3,806 feet in the Upper Mesilla Valley, on the Rio Grande's floodplain right at the New Mexico Texas state line, 24 miles south of Las Cruces and 18 miles north of El Paso. The town's low elevation keeps it in the warmer end of the Chihuahuan Desert, and its economy still runs on irrigated pecan, cotton and alfalfa farming, which means the valley floor around Anthony holds more soil moisture through the growing season than the dry desert uplands most New Mexico towns sit on.",
    topPests: ["Bark Scorpions", "Subterranean Termites", "Packrats", "Black Widow Spiders"],
    pestProfile: [
      {
        name: "Bark Scorpions",
        serviceSlug: "scorpion-control",
        activeSeason: "April through October, most active after dark",
        note: "Anthony's low elevation in the Mesilla Valley keeps summer nights warm enough for bark scorpions to stay active later into the evening and later into the fall than a higher desert New Mexico town would see.",
      },
      {
        name: "Subterranean Termites",
        serviceSlug: "termite-treatment",
        activeSeason: "Year-round below ground, swarms in spring",
        note: "Anthony's pecan orchards, cotton fields and alfalfa acreage depend on flood and furrow irrigation, and that steady soil moisture across the valley floor gives subterranean termites easier ground-to-structure access than a dry upland desert lot would.",
      },
      {
        name: "Packrats",
        serviceSlug: "rodent-control",
        activeSeason: "Year-round, most active in fall",
        note: "Packrats build stick nests along fence lines, irrigation ditches and orchard understory throughout Anthony's farmland, and those nests sit close enough to homes, sheds and vehicles that packrats regularly move into them looking for more shelter.",
      },
      {
        name: "Black Widow Spiders",
        serviceSlug: "spider-control",
        activeSeason: "Year-round, most active in warmer months",
        note: "Farm equipment sheds, irrigation valve boxes and stacked field supplies common on Anthony's agricultural properties give black widow spiders the dark, undisturbed cover this species needs.",
      },
    ],
    localHook: "Anthony and its twin city just across the state line in Texas share the title Leap Year Capital of the World, a designation both states' governors made official after residents began a World Leap Year Festival in 1988. The town became its own incorporated municipality only in 2010, after a resident vote, and its economy is still anchored in the pecan, cotton and alfalfa farming that has defined the Upper Mesilla Valley for generations.",
    intro: "Pest control in Anthony has to account for a low desert farming town that only recently became its own incorporated city. Anthony sits at about 3,806 feet in the Upper Mesilla Valley, right on the New Mexico Texas state line, and its low elevation keeps summer nights warm enough for bark scorpions to stay active later into the year than a higher New Mexico desert town would see. The pecan orchards, cotton fields and alfalfa acreage that anchor Anthony's economy depend on flood and furrow irrigation, and that steady moisture across the valley floor gives subterranean termites an easier path from soil to structure than a dry upland lot has. Packrats build stick nests along fence lines and irrigation ditches throughout the farmland, often close enough to move into a shed, vehicle or crawl space, and black widow spiders settle into the farm equipment sheds and valve boxes that come with agricultural properties. A pest plan built for Anthony has to treat it as the working farm town it still is, not just another border desert city.",
    sections: [
      {
        heading: "Anthony's Low Elevation and a Longer Scorpion Season",
        body: "At roughly 3,806 feet, Anthony sits lower than Las Cruces and most of Dona Ana County's inland desert towns, and lower elevation means warmer nights through more of the calendar year. Bark scorpions need that warmth to stay active, so a property in Anthony can see scorpion activity stretch later into October in a mild year than a higher-elevation town nearby would experience. Sealing gaps around foundation vents, door thresholds and utility penetrations, and keeping a residual perimeter treatment through the warm season, are the most effective defense against a scorpion population that simply has more active months to work with here.",
      },
      {
        heading: "Irrigated Farmland and Subterranean Termite Pressure",
        body: "Anthony's economy still runs on pecan orchards, cotton fields and alfalfa acreage, and all three depend on flood or furrow irrigation that keeps the valley floor's soil moisture well above what a dry upland desert lot would ever see. That moisture is exactly what allows subterranean termites to travel from the ground into a home's wood framing, and properties near an irrigated field or ditch line are reasonable candidates for a termite inspection even without visible damage. Older frame and adobe homes closest to actively farmed land tend to see the most consistent termite pressure in town.",
      },
      {
        heading: "Packrats and Black Widows on Anthony's Agricultural Properties",
        body: "Packrats build stick nests along fence lines, irrigation ditches and the understory beneath pecan trees throughout Anthony's farmland, and those nests sit close enough to sheds, vehicles and crawl spaces that packrats regularly move indoors looking for more shelter, sometimes causing real damage by gnawing wiring or insulation. Black widow spiders favor the same kind of undisturbed cover: farm equipment sheds, stacked field supplies and irrigation valve boxes all give them dark corners to build a web without being disturbed. Wearing gloves before reaching into storage sheds or valve boxes and keeping stored equipment organized reduces the chance of an encounter with either pest.",
      },
    ],
    prevention: [
      "Seal foundation vents, door thresholds and utility gaps to reduce bark scorpion entry, particularly given Anthony's longer warm season.",
      "Have irrigated or ditch-adjacent properties checked for subterranean termites, since farmland moisture raises pressure well above a dry upland lot.",
      "Clear stick nests and debris from fence lines and orchard understory promptly to keep packrats from moving into sheds or vehicles.",
      "Wear gloves before reaching into farm equipment sheds, irrigation valve boxes or stacked field supplies where black widow spiders shelter.",
    ],
    costNote: "A general scorpion, termite inspection, packrat and spider treatment plan in Anthony typically runs $150 to $325, with termite treatment for irrigated or ditch-adjacent properties quoted separately after an inspection. Free inspection included with most service plans.",
    faqs: [
      {
        question: "Why do scorpions seem more active in Anthony than in Las Cruces?",
        answer: "Anthony sits lower, at about 3,806 feet, than Las Cruces and most of Dona Ana County's other towns, and lower elevation means warmer nights through more of the year. Bark scorpions rely on that warmth to stay active, so an Anthony property can see scorpion activity continue later into October in a mild year than a higher-elevation town in the same county would.",
      },
      {
        question: "Does Anthony's farmland make termites more of a problem?",
        answer: "Yes. Anthony's economy still depends on pecan, cotton and alfalfa farming, and the flood and furrow irrigation those crops need keeps soil moisture across the valley floor well above what a dry upland desert lot would ever have. That moisture gives subterranean termites an easier path from the ground into a home, especially for properties near an irrigated field or ditch.",
      },
      {
        question: "Are packrats a real problem for Anthony homes?",
        answer: "They can be. Packrats build stick nests along fence lines, irrigation ditches and under pecan trees throughout Anthony's farmland, and those nests are often close enough to sheds, vehicles and crawl spaces that packrats move indoors looking for more shelter, sometimes gnawing wiring or insulation in the process.",
      },
      {
        question: "What is the Leap Year Capital of the World connection to Anthony?",
        answer: "Anthony, New Mexico and its twin city Anthony, Texas share the official title Leap Year Capital of the World, a designation both states' governors made after residents started a World Leap Year Festival in 1988. Anthony itself only became an incorporated New Mexico municipality in 2010, following a resident vote.",
      },
    ],
    author: "Dr. Lena Ortiz, Board-Certified Entomologist (BCE), PestRemovalUSA",
    nearbyCities: [
    ...
    contentTemplate: "B",
    contentSoul: "neighbor",
    metaTitle: "Pest Control in Anthony, NM | Bark Scorpions, Termites & Packrats",
    metaDescription: "Anthony, NM pest control for bark scorpions, subterranean termites, packrats and black widow spiders in the Mesilla Valley farm belt. Free inspection. Call 1-800-PEST-USA.",
  },
];
